...
const authentication = async () => {
    const auth = new google.auth.GoogleAuth({
        ...
        credentials: {
            ...
            client_email:
                "spread-sheet@glass-cycle-370910.iam.gserviceaccount.com",
            ...
            client_x509_cert_url:
                "https://www.googleapis.com/robot/v1/metadata/x509/spread-sheet%40glass-cycle-370910.iam.gserviceaccount.com",
        },
    });
    ...
    try {
        ...
        client
            ...
            .then(async (data) => {
                // Writing Data into Spreadsheet
                const writeReq = await sheets.spreadsheets.values.append({
                    spreadsheetId: data[0].SheetID,
                    range: data[0].SheetName,
                    valueInputOption: "USER_ENTERED",
                    resource: {
                        values: [[name, phoneNumber]],
                    },
                ...
                return res.json({
                    message: "Something wrong while appending data.",
                });
            })
            .catch(console.error);
    } catch (err) {
