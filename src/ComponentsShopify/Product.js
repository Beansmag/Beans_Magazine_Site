...
export default () => {
    ...
    useEffect(() => {
        ...
        setrowPositionStart(
            Math.round(featured.length / 2) * (-100 / featured.length) -
                (-100 / featured.length) * 3.25
        );
    }, [featured]);
    ...
    useEffect(() => {
        ...
        bgImg.src =
            videoData &&
            videoData[modalIndex + 1] &&
            videoData[modalIndex + 1].backgroundGif.asset.url;
    ...
    useEffect(() => {
        ...
        bgImg.src =
            videoDataMobile &&
            videoDataMobile[modalIndex + 1] &&
            videoDataMobile[modalIndex + 1].backgroundGifMobile.asset.url;
    ...
    const handleSignUpSubmit = async () => {
        const response = await axios.post(
            "https://beans-magazine.com/.netlify/functions/api/updateUserData",
            signUpData
        );
        ...
        <Container style={{position: "fixed", height: "100vh", width: "100vw"}}>
            ...
            <div className="d-xs-none d-md-none d-none d-lg-block d-md-block">
                {!prodModal ? (
                    <div>
                        <div
                            className="prod-button-left"
                            style={{top: `${window > 600 ? "70vh" : "53vh"}`}}
                        >
                            <img
                                src={Arrow}
            ...
            <Row
                style={{opacity: `${prodModal ? "0" : "1"}`}}
                className="d-xs-none d-md-none d-none d-lg-block d-md-block"
            >
                <Col
                    lg={{offset: 4, span: 8}}
                    xs={{offset: 2, span: 10}}
                    className="prod-title"
                    style={{marginTop: `${window > 600 ? "23vh" : "28vh"}`}}
                >
                    <h1 className="prod-title-text">
            ...
            >
                <Col
                    ...
                    style={{marginTop: `${window > 600 ? "72vh" : "60vh"}`}}
                >
                    <h1 className="prod-price-text">{`$${
                        category[index] !== undefined
                            ? category[index].variants[0].price?.amount
                                ? category[index].variants[0].price?.amount
                                : category[index].variants[0].price
                            : ""
                    }*`}</h1>
                </Col>
            </Row>
            ...
            {!prodModal ? (
                <ul
                    className="mainMenu-ul"
                    style={{marginTop: mobileView ? "10vh" : "15vh"}}
                >
                    <li className="mainMenu-li">
                        <h5
                            className={
                                category === featured
                                    ? "product-category-text-selected"
                        ...
                        <h5
                            ...
                            onClick={(e) => {
                                ...
                                setrowPositionStart(
                                    tops.length === 1
                                        ? 0
                                        : Math.round(tops.length / 2) *
                                              (-100 / tops.length) -
                                              (-100 / tops.length) * 3.25
                                );
                            }}
                        >
                            TOPS
                        ...
                        <h5
                            ...
                            onClick={(e) => {
                                ...
                                setrowPositionStart(
                                    bottoms.length === 1
                                        ? 0
                                        : Math.round(bottoms.length / 2) *
                                              (-100 / bottoms.length) -
                                              (-100 / bottoms.length) * 3.25
                                );
                            }}
                        >
                            BOTTOMS
                        ...
                        <h5
                            ...
                            onClick={(e) => {
                                ...
                                setrowPositionStart(
                                    magazines.length === 1
                                        ? 0
                                        : Math.round(magazines.length / 2) *
                                              (-100 / magazines.length) -
                                              (-100 / magazines.length) * 3.25
                                );
                            }}
                        >
                            MAGAZINE
                            ...
                            onClick={(e) => {
                                ...
                                setrowPositionStart(
                                    accessories.length === 1
                                        ? 0
                                        : Math.round(accessories.length / 2) *
                                              (-100 / accessories.length) -
                                              (-100 / accessories.length) * 3.25
                                );
                            }}
                        >
                            ACCESSORIES
            ...
            >
                <div
                    ...
                    style={{marginTop: "15vh", paddingBottom: "5vh"}}
                >
                    {category &&
                        category !== null &&
                ...
                {prodModal ? (
                    ...
                    >
                        <h3 style={{fontWeight: "800", fontSize: "30px"}}>
                            {missionCartInfo &&
                                missionCartInfo[0].missionHeader}
                        </h3>
                        <h3 style={{paddingBottom: "12vh", fontWeight: "800"}}>
                            <BlockContent
                                blocks={
                                    missionCartInfo &&
                                    missionCartInfo[0].missionStatementText
                                }
                                projectId="m7j507qg"
                                dataset="headless"
                            />
                ...
                >
                    {category &&
                        category.map((product, i) => {
                            ...
                            return (
                                <div
                                    className="home-prod-row"
                                    key={i}
                                    style={{width: `${rowWidth && rowWidth}%`}}
            ...
            {prodModal && videoData[index + 1] !== undefined && window > 600 ? (
                <animated.div style={styles}>
                    <div
                        ...
                        style={{
                            backgroundImage: `url(${
                                videoData[modalIndex + 1] !== null
                                    ? videoData[modalIndex + 1].backgroundGif
                                          .asset.url
                                    : videoData[0].backgroundGif.asset.url
                            })`,
                        }}
                    ></div>
                </animated.div>
            ...
            {prodModal &&
            videoDataMobile[index + 1] !== undefined &&
            window < 600 ? (
                <animated.div style={stylesMobile}>
                    <div
                        ...
                        style={{
                            backgroundImage: `url(${
                                videoDataMobile[modalIndex + 1] !== null
                                    ? videoDataMobile[modalIndex + 1]
                                          .backgroundGifMobile.asset.url
                                    : videoDataMobile[0].backgroundGifMobile
                                          .asset.url
                            })`,
                        }}
                    ></div>
                ...
                <div
                    ...
                    style={{
                        backgroundImage: `url(${
                            window < 600
                                ? videoDataMobile &&
                                  videoDataMobile[0].backgroundGifMobile.asset
                                      .url
                                : ""
                        })`,
                    }}
            ...
            <Modal show={show} centered>
                ...
                <Modal.Body>
                    <div class="modalimgright">
                        <img
                            className="modalCloseSvg"
                            src={Close}
                            onClick={() => {
                                setShow(false);
            ...
            <Modal show={showSuccess} centered>
                <Modal.Header>
                    <Modal.Title className="successModalTitle">
